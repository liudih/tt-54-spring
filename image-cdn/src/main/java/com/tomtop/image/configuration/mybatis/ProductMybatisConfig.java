 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.product.mappers", sqlSessionFactoryRef = "productSqlSessionFactory")
public class ProductMybatisConfig {
	...
	public DataSource dataSource() {
		...
		ds.setDriverClass(jdbcConnectionSettings.getProductDriver());
