 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.member.mappers", sqlSessionFactoryRef = "memberSqlSessionFactory")
public class MemberMybatisConfig {
	...
	public SqlSessionFactory memberSqlSessionFactory(
		...
		sqlSessionFactory.setMapperLocations(getResource("mapper/member",
				"**/*.xml"));
