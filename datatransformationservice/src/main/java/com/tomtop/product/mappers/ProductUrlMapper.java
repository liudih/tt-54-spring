...
public interface ProductUrlMapper {
	...
	@Select("select curl,ilanguageid from t_product_url where clistingid = #{0} and iwebsiteid=#{1}")
	List<ProductUrl> geUrlsByListingId(String listingId, Integer client);
