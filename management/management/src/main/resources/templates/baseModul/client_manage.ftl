...
<div class="breadcrumbs">
                        <ol class="breadcrumb tx_l">
                            ...
                            <li class="active"><@my.message "base.client.title"/></li>
                        </ol>
                    </div>
<div class="row">
<div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label col-md-4"><@my.message "base.client.name"/></label>
                            <div class="col-md-8">
        ...
        <div class="portlet light bordered">
           ...
           <table class="table table-striped table-bordered table-hover table-checkable order-column" id="bodyT">
                                        <thead>
                                            <tr>
					                            ...
					                            <th> <@my.message "base.client.platform"/></th>
					                            <th> <@my.message "base.client.cname"/></th>
					                            <th> <@my.message "base.client.remark"/></th>
         ...
         <!-- END EXAMPLE TABLE PORTLET-->
			...
			<div id="static" data-backdrop="static" class="modal fade" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><@my.message "base.client.content"/></h4>
                                </div>
                                    ...
                                    <div class="portlet light form no-space">
                                        ...
                                        <form id="id-form" class="form-horizontal cmxform" role="form" method="post" novalidate="novalidate">
                                            <div class="form-body">
												...
												<div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.client.site"/><span class="required" aria-required="true"> * </span></label>
                                                    <div class="col-md-8">
                                                        <select name="site_id" class="form-control" aria-required="true" aria-invalid="true">
                                                            <#list sites as site>
												...
												<div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.client.platform"/><span class="required" aria-required="true"> * </span></label>
                                                    <div class="col-md-8">
                                                        <select name="platform" class="form-control" aria-required="true" aria-invalid="true">
                                                            <#list parameters as param>
																<option value=${param.id}>${param.platform}</option>
															</#list>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.client.cname"/><span class="required">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="name" class="form-control" required placeholder="">	
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.client.remark"/></label>
                                                    <div class="col-md-8">
                                                        <textarea name="remark" id="de" class="form-control" placeholder="" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.layoutmodule.enabled"/></label>
                                                    <div class="col-md-8">
                    ...
                    <div>
		            	<span id="nameRepeatCheck" class="hide">客户端名称已存在！</span>
		            </div>
 
<#include "/message.ftl">
<script src="/js/baseModul/client.js" type="text/javascript"></script>