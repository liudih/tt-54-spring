<div class="breadcrumbs">
                        <ol class="breadcrumb tx_l">
                            ...
                            <li class="active"><@my.message "base.language.title"/></li>
                        </ol>
                    </div>
<div class="row">
<div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label col-md-4"><@my.message "base.language.code"/></label>
                            <div class="col-md-8">
                                <input type="text" id="code" class="form-control" placeholder=""> </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label col-md-4"><@my.message "base.language.cname"/></label>
                            <div class="col-md-8">
        ...
        <div class="portlet light bordered">
           ...
           <table class="table table-striped table-bordered table-hover table-checkable order-column" id="bodyT">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> <@my.message "base.language.code"/></th>
					                            <th> <@my.message "base.language.cname"/></th>
         ...
         <#include "/page.ftl">
           ...
           <div id="static" data-backdrop="static" class="modal fade" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><@my.message "base.language.content"/></h4>
                                </div>
                                    ...
                                    <div class="portlet light form no-space">
                                        ...
                                        <form id="id-form" class="form-horizontal cmxform" role="form" method="post" novalidate="novalidate">
                                            <div class="form-body">
												...
												<div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.language.code"/><span class="required">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="code" class="form-control" required placeholder="">	
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.language.cname"/><span class="required">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="name" class="form-control" required placeholder="">	
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-md-4 control-label"><@my.message "base.layoutmodule.sort"/></label>
													<div class="col-md-8">
														<input type="number" name="sort" class="form-control input-lg" placeholder="" />							
													</div>
                                                </div>
                                                <div class="form-group">
                    ...
                    <div>
		            	<span id="nameRepeatCheck" class="hide">语言名称已存在！</span>
		            	<span id="codeRepeatCheck" class="hide">代码名称已存在！</span>
		            </div>
			
<#include "/message.ftl">

<script src="/js/baseModul/language.js" type="text/javascript"></script>