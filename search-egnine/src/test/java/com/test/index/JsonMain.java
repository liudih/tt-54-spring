...
//		38085e8b-6ef5-417b-885e-8b6ef5f17bc5
		
		
		bean.setLanguageName("ru");
		bean.setWebSites("1");
//		bean.setKeyword("P1056R-US");
...
//			String url ="http://localhost:8080/search-engine/search/qmorelikeforcustomersitem/en/1/237172f7-d5e9-474a-b172-f7d5e9d74ab2";
...
//		String url = "http://localhost:8080/search-engine/search/qmlike/en/1/00ba6fb5-d914-1004-874c-d371c9ab96c0";
	...
	public void testQueryListingId(){
		String url ="http://localhost:8080/search-engine/search/qlistingid/en/1/1f0bea2f-eeae-4e66-8bea-2feeae9e668e";
		String resData = HttpClientUtil.doPost(url,null);
		System.out.println(resData);
	}
...
//			list.add("00b8ccd9-d914-1004-874c-d371c9ab96c0");
			...
			String json = JSONObject.toJSONString(list);
//			String url ="http://169.53.70.7:8009/search/qhome/en/1";
			String url = "http://169.53.70.7:8009/search-engine/search/qmlike/en/1";
//			String url = "http://localhost:8080/search/qlistingid/en/1/006309cc-d914-1004-874c-d371c9ab96c0,009ac42f-d914-1004-874c-d371c9ab96c0";
//			String url = "http://localhost:8080/search-engine/search/qhome/en/1";
//			String url = "http://192.168.220.55:8009/search-engine/search/qhot/en/1";
	...
	public void insert(JsonMain main) throws Exception{
		String path = JsonMain.class.getClassLoader().getResource("").toURI().getPath()+"/templates/conversion_index_error.json";
		File file = new File(path);
		String product = org.apache.commons.io.FileUtils.readFileToString(file);
		String url = "http://localhost:8080/search-engine/index/insert";
//		ProductEntity product = main.getBean();
//		String json = JSONObject.toJSONString(product);
//		System.out.println(json);
		
		HttpClientUtil.doPost(url,product);
