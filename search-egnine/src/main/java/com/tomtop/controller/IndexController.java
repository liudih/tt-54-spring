...
import com.tomtop.filters.IndexFilterHelper;
...
public class IndexController {
	...
	public Map<String, Object> updateIndexPart(@PathVariable String language,
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				String route = BaseIndexInfo.ROUTE.getString(key);
				if (route != null) {
	...
	public Map<String, Object> updateIndexPart(@PathVariable String listingid,
		...
		try {
			...
			List<Language> languages = BaseServiceUtil.getLanguage();
