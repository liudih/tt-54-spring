 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.ipn.mappers.base", sqlSessionFactoryRef = "baseSqlSessionFactory")
public class BaseMybatisConfig {
	...
	public DataSource dataSource() {
		...
		ds.setDriverClass(jdbcConnectionSettings.getBaseDriver());
		...
		if (jdbcConnectionSettings.getBaseMaxConnectionsPerPartition() != null) {
			ds.setMaxConnectionsPerPartition(jdbcConnectionSettings
					.getBaseMaxConnectionsPerPartition());
		}
		if (jdbcConnectionSettings.getBaseMinConnectionsPerPartition() != null) {
			ds.setMinConnectionsPerPartition(jdbcConnectionSettings
					.getBaseMinConnectionsPerPartition());
		}
